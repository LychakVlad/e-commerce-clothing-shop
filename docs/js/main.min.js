...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var secondSwiper = new Swiper('.clothes-slider', {
    breakpoints: {
      800: {
        slidesPerView: 4
      },
  ...
  if (menuButton) {
    ...
    var burgerIcon = document.querySelector('.header__menu-item--trigger');
  ...
  ;
  document.querySelectorAll('.faq-accordion-item__question').forEach(function (item) {
  ...
  document.querySelectorAll('.header-menu__title').forEach(function (item) {
    return item.addEventListener('click', function () {
      var parent = item.parentNode;
      var accordionContent = item.nextElementSibling;
      if (parent.classList.contains('open')) {
        ...
        document.querySelectorAll('.header-menu__column').forEach(function (child) {
          return child.classList.remove('open');
        });
        document.querySelectorAll('.header-menu__list').forEach(function (child) {
          return child.style.maxHeight = null;
        });
        accordionContent.style.maxHeight = accordionContent.scrollHeight + 'px';
