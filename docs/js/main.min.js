...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var itemPrices = document.querySelectorAll('.item-card__price');
  var oldPrices = document.querySelectorAll('.item-card__old-price');
  ...
  counterPlus.addEventListener('click', function (e) {
    ...
    oldPrices.forEach(function (item) {
  ...
  counterMinus.addEventListener('click', function (e) {
    ...
    counter.innerHTML = count;
    itemPrices.forEach(function (item) {
      var currentNumber = item.innerHTML.replace(/[^+\d]/g, '');
