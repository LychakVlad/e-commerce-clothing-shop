...
/* harmony import */ var _utils_header_scroll__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils/header-scroll */ "./js/utils/header-scroll.js");
...
/* harmony import */ var _modules_init_header_menu__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/init-header-menu */ "./js/modules/init-header-menu.js");
/* harmony import */ var _modules_handler_accordion__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/handler-accordion */ "./js/modules/handler-accordion.js");
/* harmony import */ var _modules_handler_tabs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/handler-tabs */ "./js/modules/handler-tabs.js");
/* harmony import */ var _modules_sliders_init_sliders__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/sliders/init-sliders */ "./js/modules/sliders/init-sliders.js");
/* harmony import */ var _modules_init_side_menu__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-side-menu */ "./js/modules/init-side-menu.js");
/* harmony import */ var _modules_form_init_payment_method__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./modules/form/init-payment-method */ "./js/modules/form/init-payment-method.js");
/* harmony import */ var _modules_handler_cards__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/handler-cards */ "./js/modules/handler-cards.js");
/* harmony import */ var _modules_handler_cart__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/handler-cart */ "./js/modules/handler-cart.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_utils_header_scroll__WEBPACK_IMPORTED_MODULE_1__["headerScroll"])();

  // Modules
  // ---------------------------------
  Object(_modules_init_header_menu__WEBPACK_IMPORTED_MODULE_5__["initHeaderMenu"])();
  Object(_modules_handler_accordion__WEBPACK_IMPORTED_MODULE_6__["initAccordion"])();
  Object(_modules_handler_tabs__WEBPACK_IMPORTED_MODULE_7__["initTabs"])();
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_sliders_init_sliders__WEBPACK_IMPORTED_MODULE_8__["initSwipers"])();
    Object(_modules_init_side_menu__WEBPACK_IMPORTED_MODULE_9__["initSideMenu"])();
    Object(_modules_handler_cart__WEBPACK_IMPORTED_MODULE_12__["cartHandler"])();
    Object(_modules_handler_cards__WEBPACK_IMPORTED_MODULE_11__["cardsHandler"])();
    Object(_modules_form_init_payment_method__WEBPACK_IMPORTED_MODULE_10__["paymentMethodCheck"])();
  });
});
...
/***/ "./js/modules/form/init-payment-method.js":
/*!************************************************!*\
  !*** ./js/modules/form/init-payment-method.js ***!
  \************************************************/
/*! exports provided: paymentMethodCheck */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "paymentMethodCheck", function() { return paymentMethodCheck; });
var paymentMethodCheck = function paymentMethodCheck() {
  var addToCartBtn = document.querySelectorAll('.card-btn');
  var cartIcon = document.querySelector('.cart-icon');
  var cartModal = document.querySelector('.cart-confirm-modal');
  var closeCartModal = function closeCartModal() {
  ...
  var paymentMethodCart = document.querySelectorAll('.custom-toggle__cart');
  var orderButton = document.querySelector('.btn__order');
  paymentMethodCart.forEach(function (item) {
...
/***/ "./js/modules/handler-accordion.js":
/*!*****************************************!*\
  !*** ./js/modules/handler-accordion.js ***!
  \*****************************************/
...
var handlerAccordion = function handlerAccordion(event) {
  var item = event.target;
  var parent = item.closest('[data-accordion="parent"]');
  var accordionContent = parent.querySelector('[data-accordion="content"]');
...
var initAccordion = function initAccordion() {
  ...
  document.querySelectorAll('[data-accordion="button"]').forEach(function (item) {
...
/***/ "./js/modules/handler-cards.js":
/*!*************************************!*\
  !*** ./js/modules/handler-cards.js ***!
  \*************************************/
/*! exports provided: cardsHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "cardsHandler", function() { return cardsHandler; });
var cardsHandler = function cardsHandler() {
  if (!document.querySelector('[data-card="wrapper"]')) {
    return;
  }
  var closeButton = document.querySelectorAll('[data-card="button-close"]');
  var cardItem = document.querySelectorAll('[data-card="card"]');
  var cardsBlock = document.querySelector('[data-card="container"]');
  var emptyPage = document.querySelector('.empty-page');
  var favWrapper = document.querySelector('[data-card="wrapper"]');
  closeButton.forEach(function (item) {
    item.onclick = function (e) {
      var current = e.target;
      var parent = current.closest('[data-card="card"]');
...
/***/ "./js/modules/handler-cart.js":
/*!************************************!*\
  !*** ./js/modules/handler-cart.js ***!
  \************************************/
/*! exports provided: cartHandler */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var cartHandler = function cartHandler() {
  ...
  var counterPlus = document.querySelectorAll('.counter-plus');
  var counterMinus = document.querySelectorAll('.counter-minus');
  var oldPrices = document.querySelector('.item-card__old-price');
  var totalPrice = document.querySelector('.cart__total-price');
  var itemPrices = document.querySelector('.item-card__price');
  var counter = document.querySelector('.counter-digit');
  var calculationPrice = itemPrices.innerHTML.replace(/[^+\d]/g, '');
  var calculationOldPrice = oldPrices.innerHTML.replace(/[^+\d]/g, '');
  var calculationTotalPrice = totalPrice.innerHTML.replace(/[^+\d]/g, '');
  counterPlus.forEach(function (item) {
    item.onclick = function (e) {
      e.preventDefault();
  ...
  counterMinus.forEach(function (item) {
    item.onclick = function (e) {
      e.preventDefault();
      var countMinus = counter.innerHTML;
      if (+countMinus >= 2) {
        counter.innerHTML--;
...
var initTabs = function initTabs() {
  ...
  var tabItem = document.querySelectorAll('[data-tab="link"]');
  tabItem.forEach(function (item) {
    item.addEventListener('click', function (e) {
      ...
      tabContent.forEach(function (child) {
        child.classList.remove('is-active');
      });
...
/*!****************************************!*\
  !*** ./js/modules/init-header-menu.js ***!
  \****************************************/
/*! exports provided: initHeaderMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var menuButton = document.querySelectorAll('.nav-menu-open');
var burgerIcon = document.querySelector('.header-menu-open');
var selectBody = document.body;
var headerMobMenu = document.querySelector('.header-menu-mob');
window.scrollLock = new _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_0__["ScrollLock"]();
var initHeaderMenu = function initHeaderMenu() {
  ...
  var handler = function handler(evt) {
    var item = evt.target;
    var menuItem = item.closest('.nav-menu-open');
    var headerMenu = menuItem.lastElementChild;
    var headerLink = menuItem.firstElementChild;
...
/***/ "./js/modules/init-side-menu.js":
/*!**************************************!*\
  !*** ./js/modules/init-side-menu.js ***!
  \**************************************/
/*! exports provided: initSideMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSideMenu", function() { return initSideMenu; });
var initSideMenu = function initSideMenu() {
  if (!document.querySelector('.catalog__filters-icon')) {
    return;
  }
  var openSideIcon = document.querySelector('.catalog__filters-icon');
  var closeSideIcon = document.querySelector('.catalog-side__close-icon');
  var catalogSideMenu = document.querySelector('.catalog-side');
...
/***/ "./js/modules/sliders/clothes-swiper.js":
/*!**********************************************!*\
  !*** ./js/modules/sliders/clothes-swiper.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
window.clothesSlider = function () {
  if (!document.querySelector('.clothes-slider-block')) {
    return;
  }
  var clothesSwiper = new Swiper('.clothes-slider-block', {
    breakpoints: {
      1000: {
        slidesPerView: 4
      },
...
/* harmony import */ var _card_swiper__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./card-swiper */ "./js/modules/sliders/card-swiper.js");
/* harmony import */ var _clothes_swiper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./clothes-swiper */ "./js/modules/sliders/clothes-swiper.js");
/* harmony import */ var _main_swiper__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./main-swiper */ "./js/modules/sliders/main-swiper.js");
...
/***/ "./js/modules/sliders/main-swiper.js":
/*!*******************************************!*\
  !*** ./js/modules/sliders/main-swiper.js ***!
  \*******************************************/
/*! exports provided: default */
...
var headerScroll = function headerScroll() {
  ...
  window.addEventListener('scroll', function () {
    ...
    var firstBlock = mainPage.clientHeight;
    if (scrollDistance >= firstBlock + headerHeight) {
      header.classList.add('is-fixed');
      mainBlock.style.marginTop = "".concat(headerHeight, "px");
    } else {
