...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var handlerAccordion = function handlerAccordion(event) {
    ...
    if (parent.classList.contains('is-active')) {
      ...
      document.querySelectorAll('.faq-accordion-item').forEach(function (child) {
        return child.classList.remove('is-active');
      });
      document.querySelectorAll('.faq-accordion-item__answer').forEach(function (child) {
        return child.style.maxHeight = null;
      });
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_header_menu__WEBPACK_IMPORTED_MODULE_4__["initHeaderMenu"])();
  });
});
